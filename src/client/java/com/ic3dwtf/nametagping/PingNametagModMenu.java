    ...
    public ConfigScreenFactory<Screen> getModConfigScreenFactory() {
        return parent -> {
            ...
            ConfigCategory general = builder.getOrCreateCategory(
                    Component.translatable("ping_nametag.config.category.general")
            );

            ConfigEntryBuilder entries = builder.entryBuilder();

            general.addEntry(entries.startBooleanToggle(
                            Component.translatable("ping_nametag.config.enabled"),
                            config.enabled
            ...
            general.addEntry(entries.startStrField(
                            Component.translatable("ping_nametag.config.text_format"),
                            config.textFormat
            ...
            general.addEntry(entries.startBooleanToggle(
                            Component.translatable("ping_nametag.config.show_own_ping"),
                            config.showOwnPing
                    ).setDefaultValue(true)
            ...
            general.addEntry(entries.startIntField(
                            Component.translatable("ping_nametag.config.good_ping_max"),
                            config.goodPingMax
                    ).setDefaultValue(80)
                    .setMin(1)
                    .setMax(2000)
            ...
            general.addEntry(entries.startIntField(
                            Component.translatable("ping_nametag.config.medium_ping_max"),
                            config.mediumPingMax
                    ).setDefaultValue(150)
                    .setMin(1)
                    .setMax(2000)
            ...
            general.addEntry(entries.startIntField(
                            Component.translatable("ping_nametag.config.bad_ping_max"),
                            config.badPingMax
                    ).setDefaultValue(250)
                    .setMin(1)
                    .setMax(2000)
            ...
            general.addEntry(entries.startColorField(
                            Component.translatable("ping_nametag.config.good_color"),
                            config.goodColor
            ...
            general.addEntry(entries.startColorField(
                            Component.translatable("ping_nametag.config.medium_color"),
                            config.mediumColor
            ...
            general.addEntry(entries.startColorField(
                            Component.translatable("ping_nametag.config.bad_color"),
                            config.badColor
            ...
            general.addEntry(entries.startColorField(
                            Component.translatable("ping_nametag.config.worst_color"),
                            config.worstColor
